...
enum GeoCurrencyIso {
  ...
  /// ISO 4217 string code, e.g. "USD".
  String get code => name;

  /// Parses [code] into a [GeoCurrencyIso].
  ///
  /// Trims and uppercases the input, then resolves via [GeoCurrencyIso.values.byName].
  /// Throws [ArgumentError] if the code is invalid.
  factory GeoCurrencyIso.withCode(String code) =>
      GeoCurrencyIso._fromCode(code);

  /// Internal parsing factory.
  factory GeoCurrencyIso._fromCode(String code) {
    final normalized = code.trim().toUpperCase();
    try {
      return GeoCurrencyIso.values.byName(normalized);
    } catch (_) {
